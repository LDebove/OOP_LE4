...
public class TestInterDeplacement {
    public static void main(String[] args) {
        ...
        System.out.println("deltaCout c5 -> 1 : " + t.deltaCoutInsertionInter(1, c5)); //
        System.out.println("deltaCout c7 -> 2 : " + t.deltaCoutInsertionInter(2, c7)); //
        System.out.println("deltaCout c7 -> -1 : " + t.deltaCoutInsertionInter(-1, c7)); // inf
        System.out.println("deltaCout c7 -> 5 : " + t.deltaCoutInsertionInter(5, c7)); // inf

        OperateurLocal op1 = OperateurLocal.getOperateur(TypeOperateurLocal.INTER_DEPLACEMENT);
        OperateurLocal op2 = OperateurLocal.getOperateurInter(TypeOperateurLocal.INTER_DEPLACEMENT, t, 1, u, 4); // TODO réalisable car deltaCout = inf - 4
        OperateurLocal op3 = OperateurLocal.getOperateurInter(TypeOperateurLocal.INTER_DEPLACEMENT, t, 3, u, 0);
        OperateurLocal op4 = OperateurLocal.getOperateurInter(TypeOperateurLocal.INTER_DEPLACEMENT, t, -1, u, 4);
        ...
        OperateurLocal best = t.getMeilleurOperateurInter(TypeOperateurLocal.INTER_DEPLACEMENT, u);
